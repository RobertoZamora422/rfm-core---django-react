...
import { ESTADO_LABELS, TIPO_SERVICIO_LABELS } from './quoteConstants'

const ESTADOS_EDITABLES = ['nueva', 'contactada', 'confirmada', 'descartada']
...
function buildInitialForm(initialValues) {
  return {
    ...
    estado: initialValues?.estado ?? 'nueva',
  ...
  return (
    <form className="resource-form" onSubmit={handleSubmit}>
      ...
      <div className="form-grid">
        ...
        >
          <option value="">
            {form.tipo_servicio === 'servicio_completo' ? 'Seleccione un paquete' : 'Sin paquete'}
          </option>
      ...
      <div className="form-grid">
        ...
        <Select
          ...
          value={form.estado}
        >
          {(isConverted ? ['convertida'] : ESTADOS_EDITABLES).map((estado) => (
